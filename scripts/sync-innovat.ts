 ...
 * 
 * Versión TypeScript del script de sync.
 * Se usa cuando no hay build compilado disponible.
 * 
 * Ejecutar con: npx tsx scripts/sync-innovat.ts
 * O directamente: node --expose-gc scripts/sync-innovat.mjs
 */
...
try {
  await syncFromInnovat(campusList, (step: SyncStep) => {
